...
type ServerEvent = MessageEventFromServer | OptionsEventFromServer | ErrorEventFromServer
                    ...
                    <div className="max-h-96 overflow-y-auto">
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pr-2">
                        {productOptions.map((p, idx) => (
                          <div
                            key={idx}
                            className="bg-gray-800/70 rounded-xl p-3 border border-teal-500/20 flex-shrink-0"
                          >
                            <img
